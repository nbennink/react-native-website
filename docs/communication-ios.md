...
Native modules can also be used to expose existing native libraries to JS. The [Geolocation library](https://github.com/react-native-community/react-native-geolocation/blob/master/ios/RNCGeolocation.m) is a living example of the idea.
